...
class ShoppingCart {
        ...
        this.items.forEach(item => {
            html += `
                <div class="summary-line">
                    ...
                    <span>
                        R$ ${(parseFloat(item.price) * item.qty)
                            .toFixed(2)
                            .replace('.', ',')}
                    </span>
                </div>
    ...
    // ===============================
    // EMAILJS
    // Envia os dados do checkout
    // para o Gmail configurado
    ...
    async processInfinitePay() {
        ...
        try {
            ...
            // Enviar pedido para Gmail mediante EmailJS
            const emailSent =
    ...
    async processStripe() {
        ...
        try {
            ...
            // ==================================
            // EMAILJS
            // Enviar dados para seu Gmail
            // antes de abrir o Stripe
            // ==================================
